 ...
 * @return {[Array]}                [圆心坐标集]
 */
export function getArcCenter(arcPointArray, rx, ry, x_axis_rotation) {
 ...
 */
export function sweepAngular(pointArray) {
    var p  = pointArray;
 ...
 */
export function cutBezier(bezierArray, t) {
 ...
 */
export function cutLine(lineArray, t) {
    var cut = _cutData(t || 0.5);
    var la = lineArray;
    var cx; 
    var cy;
 ...
 */
export function cutArc(arcArray, cutPoint) {
    var aa     = arcArray;
 ...
 */
export function upgradeBezier(bezierArray, n) {                                //toDo优化
...
export function arc2curv(arcArray, recursive) {
 ...
 * @return {[Array]}        [转换后的坐标]
 */
export function transform(matrix, coord) {
